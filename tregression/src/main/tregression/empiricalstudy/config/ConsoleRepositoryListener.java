...
public class ConsoleRepositoryListener implements RepositoryListener {
    ...
    public void metadataDeployed(RepositoryEvent event) {
        System.out.println("Deployed metadata " + event.getMetadata() + " to " + event.getRepository());
    }

    @Override
    public void metadataDeploying(RepositoryEvent event) {
        System.out.println("Deploying metadata " + event.getMetadata() + " to " + event.getRepository());
    }

    @Override
    public void metadataInstalled(RepositoryEvent event) {
        System.out.println("Installed metadata " + event.getMetadata() + " to " + event.getFile());
    }

    @Override
    public void metadataInstalling(RepositoryEvent event) {
        System.out.println("Installing metadata " + event.getMetadata() + " to " + event.getFile());
    }
    ...
    public void metadataDownloading(RepositoryEvent event) {
        System.out.println("Downloading metadata " + event.getMetadata() + " from " + event.getRepository());
    }
    ...
    public void metadataResolving(RepositoryEvent event) {
        System.out.println("Resolving metadata " + event.getMetadata());
    }
